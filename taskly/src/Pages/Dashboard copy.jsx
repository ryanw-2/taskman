...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-900 text-white">
      ...
      <p className="text-lg mb-4">Selected Button: {buttonIndex + 1}</p>
      <div className="flex space-x-4">
        <button
          ref={buttonRefList.current[0]}
          onClick={() => handleButtonClick(0)}
          className={`px-8 py-4 font-bold rounded-lg shadow-lg transition-all ${
            buttonIndex === 0
              ? "bg-blue-600 ring-4 ring-yellow-400"
              : "bg-gray-700"
          }`}
        >
          Button 1
